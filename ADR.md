...
- Deploy: API e server MCP su Render (un solo servizio), un sottodominio Cloudflare, `openvehicle.mirkobechini.com`, per API e MCP (nome provvisorio); dataset su GitHub Releases; refresh pianificato con GitHub Actions
